...
```
MONGODB_URI = mongodb+srv://<username>:<password>@cluster0.6m5cz.mongodb.net/Foods?retryWrites=true&w=majority
```
...
[Read Article](https://raddy.dev/blog/how-to-build-a-food-blog-using-node-js-and-mongodb-express-ejs-mongoose-crud/)
